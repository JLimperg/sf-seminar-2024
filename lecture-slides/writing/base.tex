...
\begin{frame}
  ...
  7000--14000 characters (ca.\ 3--5 pages), excluding bibliography and appendices
...
\begin{frame}
  ...
  Officially: summarise some (typically one) Software Foundations chapters for your fellow students.
...
\begin{frame}
  ...
  They are assumed to be familiar with
  \begin{itemize}
    \item things usually taught in the first two years of a computer science bachelor
    \item the first seven chapters of Logical Foundations (up to IndProp)
...
\begin{frame}
  ...
  Which problems/topics does the chapter address? Short examples help immensely.
...
\begin{frame}
  ...
  Select the most important idea(s) from the chapter.
  ...
  Give examples. Your own examples are worth more than examples taken from the chapter.
\end{frame}
...
\begin{frame}
  ...
  See slides by David Sabel (translated by Luca Maio) \href{https://github.com/JLimperg/sf-seminar-2024/}{in the course repository}.
\end{frame}
...
\begin{frame}
  ...
  Use many \good{examples}.

  \medskip
  \pause

  Look out for \good{common writing issues}: subject-verb separation, logical linkage, topic and stress, excessive passive or nominalisation, etc.
